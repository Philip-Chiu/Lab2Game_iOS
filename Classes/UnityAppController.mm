...
@interface UnityView (iOSScrollWheel)
...
#if PLATFORM_IOS || PLATFORM_VISIONOS
    // Stop GCMouse callbacks before detaching: the view can outlive cleanup in UaaL.
    [_UnityAppController.unityView teardownIndirectMouseInput];
#endif
